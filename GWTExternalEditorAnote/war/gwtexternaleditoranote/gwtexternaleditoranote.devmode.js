...
var __gwtModuleFunction = $wnd.gwtexternaleditoranote;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.gwtexternaleditoranote=");
    idx += (13 + "gwtexternaleditoranote".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=gwtexternaleditoranote-0.js
